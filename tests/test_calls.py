...
from app.tools.list_calls import list_calls_tool
from app.tools.create_call import create_call_tool
from app.tools.delete_call import delete_call_tool
from app.tools.get_call import get_call_tool
from app.tools.update_call import update_call_tool
...
def test_list_calls_tool(api_key_setup, setup_test_call):
    ...
    result = list_calls_tool(max_size=2)
...
def test_search_calls_tool(api_key_setup, setup_test_call):
    ...
    search_term = "Test"
    result = list_calls_tool(text_filter=search_term)
...
def test_create_and_delete_call_tool(api_key_setup):
...
def test_get_call_tool(api_key_setup, setup_test_call):
    ...
    result = get_call_tool(call_id=call_id)
...
def test_update_call_tool(api_key_setup, setup_test_call):
