...
def create_campaign_tool(
    ...
    duplicate_source_id: Annotated[
        Optional[str],
        Field(
            description="Record ID being duplicated. Sent as header 'X-Duplicate-Source-Id'."
        ),
    ] = None,
    skip_duplicate_check: Annotated[
        Optional[bool],
        Field(
            description="Skip duplicate check. Sent as header 'X-Skip-Duplicate-Check' with 'true' or 'false'."
        ),
    ] = None,
