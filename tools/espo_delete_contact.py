...
def espo_delete_contact_tool(
    contact_id: Annotated[str, Field(description="The ID of the Contact record to delete")]
) -> Dict:
    """
    ...
    Example Requests:
    - Delete a contact: espo_delete_contact_tool(contact_id="abc123")
