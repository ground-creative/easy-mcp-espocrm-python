...
def espo_update_call_tool(
    ...
    - Update call name and start time:
      espo_update_call_tool(call_id="abc123", name="Rescheduled Call", date_start="2026-02-01 09:00:00")
    - Update participants and direction:
      espo_update_call_tool(call_id="abc123", users_ids=["USER1","USER2"], contacts_ids=["CONTACT1"], direction="Inbound")
    - Update custom fields:
      espo_update_call_tool(call_id="abc123", custom_fields={"c_priority": "high", "c_score": 75})
