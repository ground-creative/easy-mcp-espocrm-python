...
def espo_update_email_tool(
    ...
    Example Requests:
    - Update subject and body: espo_update_email_tool(email_id="abc123", subject="Updated", body="New body")
    - Update parent and status: espo_update_email_tool(email_id="abc123", parent_type="Contact", parent_id="contact456", status="Sent")
    - Update custom fields: espo_update_email_tool(email_id="abc123", custom_fields={"c_processed": True})
