...
def update_contact_tool(
    contact_id: Annotated[
        str, Field(description="The ID of the Contact record to update")
    ],
    ...
    title: Annotated[
        Optional[str], Field(description="Job title (<=100 chars)")
    ] = None,
    description: Annotated[
        Optional[str], Field(description="Multi-line description / notes")
    ] = None,
    ...
    email_address_data: Annotated[
        ...
        Field(
            description="Multiple email objects with keys: emailAddress (str), primary (bool), optOut (bool, optional), invalid (bool, optional)"
        ),
    ] = None,
    ...
    phone_number_data: Annotated[
        Optional[List[Dict[str, Any]]],
        Field(
            description="Multiple phone objects with keys: phoneNumber (str), primary (bool), optOut (bool, optional), invalid (bool, optional)"
        ),
    ] = None,
    ...
    address_street: Annotated[
        Optional[str], Field(description="Street address (<=255 chars)")
    ] = None,
    ...
    account_id: Annotated[
        Optional[str], Field(description="Related Account ID")
    ] = None,
    accounts_ids: Annotated[
        Optional[List[str]], Field(description="Multiple related Account IDs")
    ] = None,
    accounts_columns: Annotated[
        Optional[Dict[str, Any]],
        Field(description="AccountID => column values mapping for relationships"),
    ] = None,
    account_role: Annotated[Optional[str], Field(description="Account role")] = None,
    account_is_inactive: Annotated[
        Optional[bool], Field(description="Account inactive flag")
    ] = None,
    opportunity_role: Annotated[
        Optional[str],
        Field(description="Opportunity role (Decision Maker, Evaluator, Influencer)"),
    ] = None,
    campaign_id: Annotated[
        Optional[str], Field(description="Related Campaign ID")
    ] = None,
    ...
    target_lists_ids: Annotated[
        Optional[List[str]], Field(description="Multiple Target List IDs")
    ] = None,
    original_email_id: Annotated[
        Optional[str], Field(description="Original Email ID")
    ] = None,
    ...
    custom_fields: Annotated[
        Optional[Dict[str, Any]],
        Field(
            description="Custom EspoCRM fields (must start with `c` prefix, e.g., cCustomField)"
        ),
    ] = None,
) -> Dict:
    """
