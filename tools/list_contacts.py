...
def list_contacts_tool(
    attribute_select: Annotated[
        Optional[List[str]],
        Field(
            description="Attributes to return. Only select necessary ones to improve performance"
        ),
    ] = None,
    bool_filter_list: Annotated[
        Optional[List[str]], Field(description="Bool filters. Allowed value: onlyMy")
    ] = None,
    max_size: Annotated[
    ...
    order: Annotated[
        Optional[str], Field(description="Order direction. Allowed values: asc, desc")
    ] = None,
    order_by: Annotated[
        Optional[str], Field(description="Attribute to order by")
    ] = None,
    primary_filter: Annotated[
        Optional[str],
        Field(
            description="Primary filter. Allowed values: portalUsers, notPortalUsers, accountActive"
        ),
    ] = None,
    ...
    where_group: Annotated[
        ...
        Field(
            description="Where conditions. Each item: {type, attribute, operator, value}"
        ),
    ] = None,
    type_filter: Annotated[Optional[str], Field(description="Record type")] = None,
    date_time: Annotated[
        Optional[bool], Field(description="Set true for date-time fields")
    ] = None,
    time_zone: Annotated[
        Optional[str], Field(description="Time zone for date-time fields")
    ] = None,
    x_no_total: Annotated[
        Optional[bool],
        Field(description="Disable calculation of total number of records"),
    ] = None,
) -> Dict:
    """
