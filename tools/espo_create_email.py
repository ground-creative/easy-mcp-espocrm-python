...
def espo_create_email_tool(
    ...
    Example Requests:
    - Create a basic email: espo_create_email_tool(subject="Hello", to="recipient@example.com", body="This is a test email.")
    - Create an email with HTML body and parent Contact: espo_create_email_tool(subject="Welcome", to="user@example.com", body="<p>Hello!</p>", is_html=True, parent_type="Contact", parent_id="abc123")
    - Create an email with a custom field: espo_create_email_tool(subject="Custom", to="user@example.com", custom_fields={"c_custom_flag": True})
