...
def espo_create_call_tool(
    ...
    - Create a basic planned outbound call:
      espo_create_call_tool(name="Intro Call", status="Planned", direction="Outbound", date_start="2026-01-01 10:00:00")
    - Create a held call linked to a Lead:
      espo_create_call_tool(name="Follow-up Call", status="Held", parent_type="Lead", parent_id="LEAD_ID_123")
    - Create a call with multiple participants:
      espo_create_call_tool(name="Sales Call", users_ids=["USER_ID_1"], contacts_ids=["CONTACT_ID_1"])
    - Create a call with custom fields:
      espo_create_call_tool(name="Demo Call", custom_fields={"c_call_score": 95, "c_recording_url": "https://example.com/recording"})
